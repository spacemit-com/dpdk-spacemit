...
static int dwmac4_wrback_get_rx_frame_len(struct dma_desc *p, int rx_coe __rte_unused)
{
...
static inline void dwmac4_get_timestamp(void *desc, uint32_t ats __rte_unused, uint64_t *ts)
{
...
static void dwmac4_rd_init_rx_desc(struct dma_desc *p, int disable_rx_ic,
				   int mode __rte_unused, int end __rte_unused,
				   int bfsize __rte_unused)
{
	dwmac4_set_rx_owner(p, disable_rx_ic);
}

static void dwmac4_rd_init_tx_desc(struct dma_desc *p, int mode __rte_unused, 
				   int end __rte_unused)
{
	p->des0 = 0;
	p->des1 = 0;
	p->des2 = 0;
...
static void dwmac4_rd_prepare_tx_desc(struct dma_desc *p, int is_fs, 
				      int len, bool csum_flag, 
				      int mode __rte_unused, 
				      bool tx_own, bool ls, 
...
static void dwmac4_release_tx_desc(struct dma_desc *p, int mode __rte_unused)
{
	p->des0 = 0;
	p->des1 = 0;
	p->des2 = 0;
