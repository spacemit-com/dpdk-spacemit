				    ...
				    dma_addr_t dma_tx_phy, u32 chan)
{
	...
	writel(upper_32_bits(dma_tx_phy), (uint8_t *)ioaddr + DMA_CHAN_TX_BASE_ADDR_HI(chan));
				  ...
				  u32 *reg_space)
{
	...
	reg_space[DMA_CHAN_TX_BASE_ADDR_HI(channel) / 4] =
		readl(ioaddr + DMA_CHAN_TX_BASE_ADDR_HI(channel));
	reg_space[DMA_CHAN_TX_BASE_ADDR(channel) / 4] =
		readl(ioaddr + DMA_CHAN_TX_BASE_ADDR(channel));
	reg_space[DMA_CHAN_RX_BASE_ADDR_HI(channel) / 4] =
		readl(ioaddr + DMA_CHAN_RX_BASE_ADDR_HI(channel));
	...
	reg_space[DMA_CHAN_CUR_TX_BUF_ADDR_HI(channel) / 4] =
		readl(ioaddr + DMA_CHAN_CUR_TX_BUF_ADDR_HI(channel));
	reg_space[DMA_CHAN_CUR_TX_BUF_ADDR(channel) / 4] =
		readl(ioaddr + DMA_CHAN_CUR_TX_BUF_ADDR(channel));
	reg_space[DMA_CHAN_CUR_RX_BUF_ADDR_HI(channel) / 4] =
		readl(ioaddr + DMA_CHAN_CUR_RX_BUF_ADDR_HI(channel));
